  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="Home">
        ...
        <Stack.Screen name="TBooking" component={TeacherBooking} options={{ title: 'Öğretmen Randevu' }} />  
        {/* Student Register Screen */}
        <Stack.Screen name="StudentLogin" component={StudentLogin} options={{ title: 'Öğrenci Girişi' }} />
        <Stack.Screen name="StudentMenu" component={StudentMenu} options={{ title: 'Öğrenci Menü' }} />
      </Stack.Navigator>
    </NavigationContainer>
  );
}
